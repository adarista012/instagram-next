...
import { SearchIcon, PlusCircleIcon, UserGroupIcon, HeartIcon, MenuIcon, PaperAirplaneIcon, } from "@heroicons/react/outline"
...
const Header = () => {
    ...
    return (
        <div className='shadow-sm border-b bg-white sticky top-0 z-50'>
            ...
            <div className='flex max-w-8xl mx-6 lgs:mx-auto justify-around'>
                {/* left */}
                ...
                <div className='flex justify-end items-center space-x-6'>
                    ...
                    (
                        ...
                        alt='profile pic' className='h-10 w-10 rounded-full cursor-pointerv'/>
                        </>
                    )
                    :(
